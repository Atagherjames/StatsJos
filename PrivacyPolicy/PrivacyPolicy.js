      ...
      <View style={styles.container}>
        <Card style={styles.card}>
          <Card.Content>
            ...
            <Text>
              StatsJos is committed to protecting the privacy of its users. This
            ...
            <Text>
              ...
              information such as your name, address, phone number, or email
              address unless you voluntarily provide it to us.
            </Text>
            <Text>
              - Non-Personal Information: We may collect non-personal
              information about you automatically when you use StatsJos, such as
              usage data, device information, and technical information like
            ...
            <Text>- To analyze usage of the app and improve our services.</Text>
            <Text>
              - To respond to your inquiries, support needs, or customer service
              requests.
            </Text>
            ...
            <Text>
              ...
              information to outside parties. However, we may share non-personal
              information with third-party service providers to assist us in
              operating StatsJos or conducting our business.
            </Text>
            ...
            <Text>
              ...
              of your information both online and offline. However, no method of
            ...
            <Text>
              ...
              they may not mirror actual exam questions. The similarity depends
              on various factors, including exam updates and changes. Using
              StatsJos can enhance familiarity with exam content but does not
              guarantee identical questions in exams.
            </Text>
