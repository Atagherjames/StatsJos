      ...
      <View style={styles.container}>
        <Card style={styles.card}>
          <Card.Content>
            ...
            <Text style={{ fontSize: 18 }}>
              - Favour Idoko: Also a 200L medical student, dedicated to creating
              impactful learning tools.
            </Text>
            <Text style={{ fontSize: 18 }}>
            ...
            <Text style={{ marginTop: 20, fontSize: 20 }}>
              Our mission is to empower students through innovative educational
              solutions. Whether you're preparing for exams or expanding your
              knowledge, StatsJos is here to support your academic journey.
            </Text>
          </Card.Content>
        </Card>
      </View>
